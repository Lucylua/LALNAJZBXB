local Configs_HUB = {
  ...
  Cor_Text = Color3.fromRGB(0, 0, 255),
...
gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 0, 255)),   -- أزرق في البداية
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 0, 0)),   -- أسود في المنتصف
    ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 0, 255))    -- أزرق في النهاية
}
  gradient.Rotation = 0
  gradient.Parent = new
